...
export default function Consulting() {
  return (
    <div style={{ marginTop: '86px' }}>
        ...
        <div className='container'>
          <div className='row'>
            <div className='col-md-6' style={{ minHeight: '450px', paddingTop: '40px', color: 'white' }}>
              ...
              <p style={{ fontSize: '60px', fontWeight: '900', marginBottom: '0px' }}>IT solutions consulting company</p>
      ...
      <div className='container' style={{ marginTop: '40px' }}>
        <div className='row'>
          <div className='col-md-6 d-flex align-items-center'>
            <div>
              <h2>IT consultation services</h2>
              <p>Today’s next-gen service providers maintain a complex set of products & services in an increasingly competitive and ever-changing market. Business Support System (BSS), Operation Support System (OSS) and Enterprise Application Solutions are required to maximize the ROI, reduce costs, offer superior customer services and accelerate time to market for new products and services. IT Consulting Services from Fullestop help businesses increase innovation, accelerate productivity, minimize costs and optimize resource utilization.</p>
          ...
          <div className='col-md-6'>
            <img style={{ borderRadius: '10px', minHeight: '300px', maxHeight: '550px', maxWidth: "100%" }} src='/Images/Whatwedo/services-consulting-itstaff-image.webp' alt='' />
          </div>
        </div>
      </div>
      <div className='container' style={{ marginTop: '40px' }}>
        <div className='d-flex justify-content-center'>
          <div className='col-md-5'>
            <p style={{ fontSize: '45px', fontWeight: '900', marginBottom: '0px' }} className='text-center'>Actionable insights from expert professionals</p>
          </div>
        </div>
        <div className='row'>
          <div className='col-md-4' style={{}} >
            <div className='card' style={{ marginTop: '30px', border: "2px solid black", minHeight: '340px' }}>
              <div className='card-body'>
                <p style={{ fontSize: '30px', fontWeight: '700', marginBottom: '0px' }}>Engagement</p>
                <p style={{ fontSize: '30px', fontWeight: '900' }}>models</p>
                <p style={{ fontSize: '16px', fontWeight: '500' }}>Fullestop follows a sophisticated strategy in delivering its services. A robust and powerful engagement model is the foundation for an effective offshore experience. Our engagement model is highly centered on fulfilling customer’s.</p>
                <Engagement />
              </div>
            </div>
          </div>
            ...
            <div className='card' style={{ marginTop: '30px', border: "2px solid black", minHeight: '340px' }}>
              <div className='card-body'>
                <div>
                  ...
                  <p style={{ fontSize: '16px', fontWeight: '500' }}>IT systems should be simple and they should work. As IT systems have become more complex, the work has become more time-consuming and expensive. This is where Fullestop can help you, by offering its tailor-made managed IT Solutions.</p>
                </div>
                <It />
              </div>
            </div>
      ...
      <div className='container' style={{ marginTop: '40px' }}>
        <p style={{ fontSize: '45px', fontWeight: '900', marginBottom: '0px' }} className='text-center'>Our IT solutions consulting</p>
      ...
      <div className='container' style={{ marginTop: '40px' }}>
        <p style={{ fontSize: '45px', fontWeight: '900', marginBottom: '0px' }} className='text-center'>Our expertise</p>
      ...
      <div className='container'>
        <p style={{ fontSize: '45px', fontWeight: '900', marginBottom: '0px' }} className='text-center'>We operate in</p>
        <div style={{ display: 'flex', justifyContent: 'center' }}>
          <div className='col-md-10' >
            <p className='text-center'>IT consulting services at Fullestop: We offer a complete range of IT-enabled services, including Project Governance Design & Analysis,
