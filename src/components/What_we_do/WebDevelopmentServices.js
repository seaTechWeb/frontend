...
export default function WebDevelopmentServices() {
    return (
        ...
        <div style={{ marginTop: '86px' }}>
            <div style={{ backgroundImage: 'linear-gradient(to right, rgba(0, 0, 0, 1.8), rgba(0, 0, 0, 0.9), rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.2)),url(/Images/Whatwedo/web-development-banner.jpg)', backgroundSize: 'cover', backgroundRepeat: 'no-repeat', backgroundPosition: 'center center' }}>
                <div className='container'>
                    <div className='row'>
                        <div className='col-md-6' style={{ minHeight: '450px', paddingTop: '40px', color: 'white' }}>
                            <h5>Driven to deliver</h5>
                            <p style={{ fontSize: '72px', fontWeight: '900', marginBottom: '0px' }}>Website development company</p>
            ...
            <div className='container' style={{ marginTop: '40px' }}>
                <div className='text-center'>
                    <h1 style={{ marginBottom: '30px' }}>Innovation & excellence powered by latest technology</h1>
                </div>
                <div className='row'>
                    {data.map((item, index) => (
