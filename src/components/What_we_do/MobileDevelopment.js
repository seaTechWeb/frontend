...
export default function MobileDevelopment() {
  ...
  return (
    ...
    <div style={{ marginTop: '86px' }}>
      <div style={{ backgroundImage: 'linear-gradient(to right, rgba(0, 0, 0, 1.8), rgba(0, 0, 0, 0.9), rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.2)),url(/Images/Whatwedo/service-mobile-banner-bg.jpg)', backgroundSize: 'cover', backgroundRepeat: 'no-repeat', backgroundPosition: 'center center' }}>
      ...
      <div className='container' style={{ marginTop: '40px' }}>
        <div className='row'>
          ...
          <div className='col-md-6'>
            <img style={{ borderRadius: '10px', maxHeight: '500px', maxWidth: '90%' }} src='/Images/Whatwedo/app-development-01.jpg' alt='' />
          </div>
        </div>
      </div>
      <div className='container' style={{ marginTop: '40px' }}>
        <div className='d-flex justify-content-center'>
          <div className='col-md-10'>
            <p className='text-center' style={{ fontSize: '48px', fontWeight: '900', marginBottom: '10px' }}>Create value through digital with our custom mobile app development services.</p>
          </div>
        </div>
        <div className='row'>
          {data.map((item, index) => (
            <div className='col-md-4' style={{ marginTop: '40px' }} key={index} >
              <div className="card custom-card">
                <div className="card-body" style={{ border: '3px solid black', borderRadius: '10px' }}>
                  ...
                  <a href="/" className="btn btn-dark webDeveloper">Learn more &rarr;</a>
                </div>
              </div>
            </div>
          ))}
      ...
      <div style={{ marginTop: '60px', paddingTop: '50px', backgroundColor: 'black', color: 'whitesmoke' }}>
        <div className='container'>
          <div className="header text-center">
            <h1 style={{ fontWeight: '900' }}>Why choose fullestop as<br />custom mobile app development agency</h1>
            <p>
      ...
      <div className='container'>
        <p className='text-center' style={{ fontSize: '40px', fontWeight: '700', marginTop: '60px' }}>How we work</p>
        <div className='d-flex align-content-start flex-wrap'>
          {steps.map((item, index) => (
            <svg width="20%" height="240" xmlns="http://www.w3.org/2000/svg" style={{ border: '2px solid #9b9898' }} key={index}>
              <image href={item.link} x="60" y="50" width="120" height="120" />
              <text x="120" y="200" fontFamily="roboto-slab" fontSize="20" fill="black" textAnchor="middle">
                {item.title}
              </text>
            </svg>
          ))}
      ...
      <div style={{ marginTop: '60px', paddingTop: '50px', backgroundColor: 'black', color: 'whitesmoke' }}>
        <div className='container'>
          <div className='d-flex justify-content-center'>
            <p style={{ fontSize: '40px', fontWeight: '700', marginRight: '20px' }}>Our</p>
            <p style={{ fontSize: '40px', fontWeight: '700', marginRight: '20px', color: '#fdd835' }}>Capabilities</p>
          </div>
          <p className='text-center' style={{ fontSize: '16px' }}>Fullestop extracts full potential of major mobile technologies and then bring on the table the most innovative solutions.
...
const data = [
  ...
  },
  {
    ...
    type: "Development",
    text: "Fullestop renders qualitative android solutions to enterprises across the globe. We have proven expertise in developing Android applications that..."
  },
  {
