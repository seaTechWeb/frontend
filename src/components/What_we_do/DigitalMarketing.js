  ...
  return (
    <div style={{ marginTop: '86px' }}>
        ...
        <div className='container'>
          <div className='row'>
            <div className='col-md-6' style={{ minHeight: '450px', paddingTop: '40px', color: 'white' }}>
              ...
              <p style={{ fontSize: '60px', fontWeight: '900', marginBottom: '0px' }}>Digital marketing services for your business</p>
      ...
      <div className='container' style={{ marginTop: '40px' }}>
        <div className='row'>
          <div className='col-md-6 d-flex align-items-center'>
            <div>
              <h2>Great qualified leads & rank high on search engines</h2>
              <p>Having a Digital Marketing Strategy is no longer an optional choice. With its reach, it is now an essential part of the mix for any respectable organisation. At Fullestop, we understand that as a business, your key objective is to reach your customers at the right place and at the right time.Our focus is your</p>
          ...
          <div className='col-md-6'>
            <img style={{ borderRadius: '10px', minHeight: '300px', maxHeight: '550px', maxWidth: '100%' }} src='/Images/Whatwedo/Great-Qualified-Leads-&-Rank.webp' alt='' />
          </div>
        </div>
      </div>
        ...
        <div className='container'>
          <div className='d-flex justify-content-center flex-column flex-md-row'>
            <div className='d-flex justify-content-center'>
              <p style={{ fontSize: '40px', fontWeight: '700', marginRight: '20px' }}>Digital</p>
              <p style={{ fontSize: '40px', fontWeight: '700', marginRight: '20px', color: '#fdd835' }}>marketing</p>
            </div>
            <p className='text-center' style={{ fontSize: '40px', fontWeight: '700', marginRight: '20px' }}>services</p>
          </div>
      ...
      <div className='container' style={{ marginTop: '40px' }}>
        <div className='row'>
          <div className='col-md-5'>
            <img style={{ borderRadius: '10px', minHeight: '300px', width: '100%' }} src='/Images/Whatwedo/seo-solutionss.webp' alt='' />
          </div>
...
const service = [
  ...
  },
  {
    ...
    title2: "An Engaging Content Strategy is Our Motto. From preparing a game plan to content production, from publishing to distribution and promotion, Fullestop's industry-leading content marketing services are engineered to achieve your business goals. Fuel your business with 100% original, powerful, and engaging content for your website, email campaigns, and social media platforms."
  },
]
...
const cardData = [
  {
    heading: "Experience",
    paragraph: "SEO is a very dynamic and undefined science you learn from experience. At Fullestop, we have been offering SEO and SEM solutions for the last 22 years and have successfully managed hundreds of projects."
  },
  {
    heading: "Team",
  ...
  {
    heading: "R&D",
    paragraph: "Search engines continuously roll out new updates. You need to stay updated. At Fullestop, we have a team of research specialists closely monitoring all campaigns, collating data and refining the strategies as per market trends."
  },
  {
  ...
  },
  {
    ...
    paragraph: "Background check. Fullestop has managed its reputation as a leading name in the SEO and SEM industry. Our clients appraise us for our results, and their words speak for our quality."
  }
]
const seoSolutions = [
