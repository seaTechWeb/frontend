...
import StripePricingTable from "./components/StripePricingTable"; // Import the pricing component
    ...
    <Router>
      <div className="roboto-slab">
        ...
        <Routes>
          ...
          <Route exact path="/pricing" element={<StripePricingTable />} /> {/* New Pricing Route */}
        </Routes>
        <Footer />
      </div>
    </Router>
